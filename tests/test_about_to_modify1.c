...
/* call about_to_modify without calling rvm_begin_trans */
void proc1() 
{
     rvm_t rvm;
     trans_t trans;
...
void proc2() 
{
     ...
     printf("OK -- test should have printed error because call about_to_modify without calling rvm_begin_trans\n");
     exit(0);
}
